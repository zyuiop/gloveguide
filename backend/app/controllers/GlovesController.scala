 ...
 */
@Singleton
class GlovesController @Inject()(cc: ControllerComponents, protecPo: ProtecPoAdapter, subst: SubstancesModel)(implicit ec: ExecutionContext) extends AbstractController(cc) {
